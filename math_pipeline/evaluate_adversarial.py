...
from evaluate import evaluate_without_gtcot
...
def load_data(data_name, split, data_dir="./data"):
    data_dir = "/share5/ru.wang/code/Qwen2.5-Math/evaluation/output_adversarial"
    data_file = f"{data_dir}/adversarial_{data_name}_Qwen2.5-Math-7B-Instruct.jsonl"
    print(data_file)
...
def main(llm, tokenizer, data_name, args):
    ...
    for example in tqdm(examples, total=len(examples)):
        ...
        #example["adversarial_question"] = parse_question(example, data_name)
        #if example["adversarial_question"] == "":
        #    continue
        ...
        sample = {
            "idx": idx,
            "question": example["new_problem"],
            "original_question": example["problem"],
            #"gt_cot": gt_cot,
            "gt": example["gt"],
            "prompt": full_prompt,
        }
    ...
    all_samples, result_json = evaluate_without_gtcot(
        samples=all_samples,
        data_name=data_name,
