...
# model = supported_VLM['DeepSeekR1'](model='deepseek-reasoner', has_reasoning=True, temperature=0, retry=3, verbose=False)
model = supported_VLM['DeepSeekV3'](model='deepseek-chat', has_reasoning=False, temperature=0, retry=3, verbose=False)
