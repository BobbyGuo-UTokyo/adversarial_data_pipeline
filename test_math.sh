python3 math_pipeline/math_eval.py --data_names math,gsm8k --data_dir output_adversarial \
    --adversarial_generation_file_name train_qwen25-math-cot_100_seed24678_t0.0_s0_e-1_name_change_only.jsonl \
    --model_name_or_path "Qwen/Qwen2.5-Math-7B-Instruct" --output_dir test_adversarial_results \
    --output_name train_qwen25-math-cot_100_seed24678_t0.0_s0_e-1_name_change_only_test_result.jsonl \
